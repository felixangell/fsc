...
# 1 "/Library/Developer/CommandLineTools/usr/bin/../lib/clang/7.0.2/include/stdint.h" 1 3 4
# 63 "/Library/Developer/CommandLineTools/usr/bin/../lib/clang/7.0.2/include/stdint.h" 3 4
...
# 64 "/Library/Developer/CommandLineTools/usr/bin/../lib/clang/7.0.2/include/stdint.h" 2 3 4
...
# 1 "/usr/local/include/collectc/array.h" 1 3
# 24 "/usr/local/include/collectc/array.h" 3
# 1 "/usr/local/include/collectc/common.h" 1 3
# 26 "/usr/local/include/collectc/common.h" 3
# 1 "/Library/Developer/CommandLineTools/usr/bin/../lib/clang/7.0.2/include/stdbool.h" 1 3 4
# 27 "/usr/local/include/collectc/common.h" 2 3
...
# 28 "/usr/local/include/collectc/common.h" 2 3
...
enum cc_stat array_filter_mut (Array *ar, _Bool (*predicate) (const void*));
enum cc_stat array_filter (Array *ar, _Bool (*predicate) (const void*), Array **out);
...
void cleanup_pools() {
    if (ALLOCATED_POOLS == ((void *)0)) return;
...
static void push_block(struct data_pool* pool) {
    ...
    (__builtin_expect(!(b != ((void *)0)), 0) ? __assert_rtn(__func__, "pool.c", 21, "b != NULL") : (void)0);
    ...
    (__builtin_expect(!(b->data != ((void *)0)), 0) ? __assert_rtn(__func__, "pool.c", 29, "b->data != NULL") : (void)0);
...
alloc(struct data_pool* pool, size_t len) {
    len = align(len, 16);
    (__builtin_expect(!(pool != ((void *)0)), 0) ? __assert_rtn(__func__, "pool.c", 61, "pool != NULL") : (void)0);
